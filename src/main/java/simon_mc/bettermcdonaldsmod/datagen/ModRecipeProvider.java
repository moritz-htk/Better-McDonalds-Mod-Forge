...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SALT_BLOCK.get(), 1)
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModBlocks.SALT_BLOCK.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.TOMATO_SEEDS.get(), 2)
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.TOMATO_SEEDS.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.LETTUCE_SEEDS.get(), 2)
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.LETTUCE_SEEDS.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.CHEESE.get(), 2)
                ...
                .unlockedBy(getHasName(ModItems.SALT.get()), has(ModTagProvider.Items.SALT))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.CHEESE.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.TORTILLA.get(), 2)
                ...
                .unlockedBy(getHasName(ModItems.SALT.get()), has(ModTagProvider.Items.SALT))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.TORTILLA.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.BEEF_PATTY.get(), 2)
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.BEEF_PATTY.get())));

        SimpleCookingRecipeBuilder.generic(Ingredient.of(ModItems.BEEF_PATTY.get()), RecipeCategory.FOOD, ModItems.COOKED_BEEF_PATTY.get(), 1.0f, 200, RecipeSerializer.SMELTING_RECIPE, SmeltingRecipe::new)
                .unlockedBy(getHasName(ModItems.BEEF_PATTY.get()), has(ModItems.BEEF_PATTY.get()))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.COOKED_BEEF_PATTY.get()) + "_smelting"));

        SimpleCookingRecipeBuilder.generic(Ingredient.of(ModItems.BEEF_PATTY.get()), RecipeCategory.FOOD, ModItems.COOKED_BEEF_PATTY.get(), 1.0f, 100, RecipeSerializer.SMOKING_RECIPE, SmokingRecipe::new)
                .unlockedBy(getHasName(ModItems.BEEF_PATTY.get()), has(ModItems.BEEF_PATTY.get()))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.COOKED_BEEF_PATTY.get()) + "_smoking"));

        SimpleCookingRecipeBuilder.generic(Ingredient.of(ModItems.BEEF_PATTY.get()), RecipeCategory.FOOD, ModItems.COOKED_BEEF_PATTY.get(), 1.0f, 600, RecipeSerializer.CAMPFIRE_COOKING_RECIPE, CampfireCookingRecipe::new)
                .unlockedBy(getHasName(ModItems.BEEF_PATTY.get()), has(ModItems.BEEF_PATTY.get()))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.COOKED_BEEF_PATTY.get()) + "_campfire_cooking"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BACON.get(), 2)
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.RAW_BACON.get())));

        SimpleCookingRecipeBuilder.generic(Ingredient.of(ModItems.RAW_BACON.get()), RecipeCategory.FOOD, ModItems.COOKED_BACON.get(), 1.0f, 200, RecipeSerializer.SMELTING_RECIPE, SmeltingRecipe::new)
                .unlockedBy(getHasName(ModItems.RAW_BACON.get()), has(ModItems.RAW_BACON.get()))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.COOKED_BACON.get()) + "_smelting"));

        SimpleCookingRecipeBuilder.generic(Ingredient.of(ModItems.RAW_BACON.get()), RecipeCategory.FOOD, ModItems.COOKED_BACON.get(), 1.0f, 100, RecipeSerializer.SMOKING_RECIPE, SmokingRecipe::new)
                .unlockedBy(getHasName(ModItems.RAW_BACON.get()), has(ModItems.RAW_BACON.get()))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.COOKED_BACON.get()) + "_smoking"));

        SimpleCookingRecipeBuilder.generic(Ingredient.of(ModItems.RAW_BACON.get()), RecipeCategory.FOOD, ModItems.COOKED_BACON.get(), 1.0f, 600, RecipeSerializer.CAMPFIRE_COOKING_RECIPE, CampfireCookingRecipe::new)
                .unlockedBy(getHasName(ModItems.RAW_BACON.get()), has(ModItems.RAW_BACON.get()))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.COOKED_BACON.get()) + "_campfire_cooking"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.MAYONNAISE.get(), 2)
                ...
                .unlockedBy(getHasName(Items.MILK_BUCKET), has(Items.MILK_BUCKET))
                .unlockedBy(getHasName(Items.EGG), has(Items.EGG))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.MAYONNAISE.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SWEET_SOUR_SAUCE.get(), 2)
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.SWEET_SOUR_SAUCE.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.KETCHUP.get(), 2)
                ...
                .unlockedBy(getHasName(ModItems.SALT.get()), has(ModTagProvider.Items.SALT))
                .unlockedBy(getHasName(ModItems.TOMATO.get()), has(ModTagProvider.Items.TOMATO))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.KETCHUP.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.MUSTARD.get(), 2)
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.MUSTARD.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HAMBURGER.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.HAMBURGER.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.CHEESEBURGER.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.CHEESEBURGER.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.MCBACON.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.MCBACON.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.BIG_MAC.get())
                ...
                .unlockedBy(getHasName(ModItems.CHEESE.get()), has(ModItems.CHEESE.get()))
                .unlockedBy(getHasName(ModItems.LETTUCE.get()), has(ModTagProvider.Items.LETTUCE))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.BIG_MAC.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.CHICKENBURGER.get())
                ...
                .unlockedBy(getHasName(ModItems.LETTUCE.get()), has(ModTagProvider.Items.LETTUCE))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.CHICKENBURGER.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.MCCHICKEN.get())
                ...
                .unlockedBy(getHasName(ModItems.LETTUCE.get()), has(ModTagProvider.Items.LETTUCE))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.MCCHICKEN.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.FILET_O_FISH.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.FILET_O_FISH.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.MCWRAP.get())
                ...
                .unlockedBy(getHasName(ModItems.MAYONNAISE.get()), has(ModItems.MAYONNAISE.get()))
                .unlockedBy(getHasName(ModItems.LETTUCE.get()), has(ModTagProvider.Items.LETTUCE))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.MCWRAP.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SNACK_SALAD.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.SNACK_SALAD.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.CHICKEN_MCNUGGETS.get())
                ...
                .unlockedBy(getHasName(ModItems.KNIFE.get()), has(ModItems.KNIFE.get()))
                .unlockedBy(getHasName(Items.COOKED_CHICKEN), has(Items.COOKED_CHICKEN))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.CHICKEN_MCNUGGETS.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.FRIES.get(), 2)
                ...
                .unlockedBy(getHasName(ModItems.SALT.get()), has(ModTagProvider.Items.SALT))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.FRIES.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HAPPY_MEAL.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.HAPPY_MEAL.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COCA_COLA.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.COCA_COLA.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.FANTA.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.FANTA.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SPRITE.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.SPRITE.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.LIPTON_ICE_TEA_PEACH.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.LIPTON_ICE_TEA_PEACH.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.MCFLURRY.get())
                ...
                .unlockedBy(getHasName(Items.SUGAR), has(Items.SUGAR))
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.MCFLURRY.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.KNIFE.get())
                ...
                .save(output, new ResourceLocation(BetterMcDonaldsMod.MOD_ID, getItemName(ModItems.KNIFE.get())));
    }
}